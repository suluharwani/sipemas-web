...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url('assets/adm')?>/assets/css/main/app-dark.css">
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="<?=base_url('assets/adm')?>/assets/images/logo/logo.svg" alt="Logo" srcset=""></a>
            </div>
